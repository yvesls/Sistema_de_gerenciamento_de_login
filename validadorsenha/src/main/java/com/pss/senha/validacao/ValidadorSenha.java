...
public final class ValidadorSenha {
    ...
    private final ArrayList<TratadorSenha> tratadores = new ArrayList<TratadorSenha>();
    ...
    public List<String> validar(String senha) {
        ...
        if (senha == null) {
            return new ArrayList<String>(Arrays.asList("Informe uma senha;"));
        }
        ...
        ArrayList<String> resultadosValidacao = new ArrayList<String>();
