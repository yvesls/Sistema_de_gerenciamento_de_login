...
public class Notificacao {
	 ...
	 * @ yves
	 * NotificacaoService, enviarNotificacaoAllUsuarios(EnviarNotificacaoAllUsersPresenter), enviarNotificacao(EnviarNotificacaoUserPresenter) */
