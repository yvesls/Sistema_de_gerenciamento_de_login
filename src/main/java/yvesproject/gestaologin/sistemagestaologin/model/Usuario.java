...
public class Usuario {
	 ...
	 * @ yves
	 * enviarNotificacaoAllUsuarios(EnviarNotificacaoAllUsersPresenter), enviarNotificacao(EnviarNotificacaoUserPresenter),
	 * autentificarUsuario(NotificacoesAdminPresenter), InvalidarAutentificacaoUsuario(NotificacoesAdminPresenter) */
	 ...
	 * @ yves
	 * executaRegistro (RegistrarPresenter), regatarAcoesView (LoginPresenter) */
	...
	/* modifica o status do usuário para 'ativo'
	 * @ yves
	 * autentificarUsuario (NotificacoesAdminPresenter) */
	public void ativarUsuarioState(Usuario modificarStateUsuario) {
        this.status.ativarUsuario(modificarStateUsuario);
    }

	/* modifica o status do usuário para 'cancelado'
	 * @ yves
	 * InvalidarAutentificacaoUsuario (NotificacoesAdminPresenter) */
